...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--toolchain=msvc --enable-shared --disable-static --disable-debug --prefix=./out/
prefix=./out/
...
CC_IDENT=用于 x64 的 Microsoft (R) C/C++ 优化编译器 19.00.24215.1 版
ARCH=x86
INTRINSICS=none
CC=cl
CXX=cl
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS -D_WIN32_WINNT=0x0502 -DPIC -I$(SRC_PATH)/compat/atomics/win32
CFLAGS= -nologo     -W3 -wd4018 -wd4146 -wd4244 -wd4305 -wd4554 -O2   -d2SSAOptimizer- -utf-8
...
HOSTCPPFLAGS= -D_ISOC99_SOURCE -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS -D_WIN32_WINNT=0x0502
HOSTEXESUF=
HOSTLDFLAGS= -nologo
HOSTEXTRALIBS=-lm
DEPHOSTCC=cl
...
EXTRALIBS=gdi32.lib psapi.lib ole32.lib strmiids.lib uuid.lib oleaut32.lib shlwapi.lib user32.lib ws2_32.lib vfw32.lib user32.lib secur32.lib psapi.lib advapi32.lib shell32.lib ole32.lib 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
